...
func (a *Actions) ForwardQueue() {
	...
	if (a.bot.Room.MaxDjs-a.bot.Room.Djs.Size()) == 0 && !a.bot.Users.UserIsCurrentDj(a.bot.Room.Song.DjId) {
		if err := a.bot.Users.EscortDj(a.bot.Room.Song.DjId); err == nil {
...
func (a *Actions) ShowSongStats() {
	if a.bot.Users.UserIsModerator(a.bot.Identity.Id) && a.bot.Config.AutoShowSongStatsEnabled && a.bot.Room.Song.Title != "" {
