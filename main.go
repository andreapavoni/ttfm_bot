...
func main() {
	ttfm.Start(ttfm.Config{
		...
		AutoDj:              utils.GetEnvBoolOrDefault("TTFM_AUTO_DJ", true),
		...
		AutoShowSongStats:   utils.GetEnvBoolOrDefault("TTFM_AUTO_SHOW_SONG_STATS", true),
		ModAutoWelcome:      utils.GetEnvBoolOrDefault("TTFM_AUTO_WELCOME", true),
